<!DOCTYPE html>
<!-- UNIMAP - PROYECTO INNOVATEC
 PROYECTO CREADO POR ANGEL SALINAS Y JUAN PABLO CHAVEZ
 HACIENDO USO DE LEAFLET Y QGIS PARA LA RENDERIZACION DEL MAPA
 EN COLABORACION CON MIGUEL ESPARZA -->
...
<html>
    <head>
        ...
        <script src="json/GeoTec.js"></script>
        <style type="text/css">
    ...
    <body>
        ...
        <script>
            ...
            var tilesource_layer = L.tileLayer('Teselas//{z}/{x}/{y}.jpg', {minZoom: 15, maxZoom: 19, tms: false, attribution: 'Imagenes extraidas de Google Maps y Renderizacion haciendo uso de las tecnologias Open Source de Leafley y QGIS.\n Mapa disenado por Juan Pablo e informacion de los edificios recolectada por Angel Daniel'}).addTo(map);
            ...
            L.geoJSON(datosTec, {
                ...
                onEachFeature: function (feature, layer){
                    ...
                    layer.on('click', function(){
                        ...
                        if(datos){
                            var folder = datos.carpeta || id;
                            fetch('index.php?p=getimages&folder=' + encodeURIComponent(folder))
                            .then(response => response.json())
                            .then(imagenes =>{
                                var imagenesHTML='';
